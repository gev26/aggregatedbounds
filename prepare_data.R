...
prepared_data<-read.dta(paste0(my_path,"data_for_analysis_ver12.dta"))
ed_vars<-read.dta(paste0(my_path,"oregonhie_ed_vars.dta"))
state_vars<-read.dta(paste0(my_path,"oregonhie_stateprograms_vars.dta"))
...
)],paste0(my_path,"prepared_data.csv"))
...
write_feather(prepared_data[,c("person_id","household_id","treatment", "ohp_all_ever_survey","female_list","english_list","zip_msa","group_id",
                               ...
                               utilization_outcomes,
                               cost_outcomes,numeric_health_outcomes
)],paste0(my_path,"prepared_data.feather"))
